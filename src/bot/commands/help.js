	...
	async buildDisplay(message) {
		...
		for (const [category, list] of commands) {
			display.addPage(new MessageEmbed()
				.setAuthor(`${category} Commands`, "https://images-ext-1.discordapp.net/external/o03EtAvKWPy_yjaQx-iLF3900MX79QsQ5SiXfU3-UK0/https/discordbots.app/logo.png?width=613&height=613")
				.setDescription('(Uptime)[https://stats.uptimerobot.com/JWYo3U8G8n]')
        .setColor(color)
				.setDescription(list.map(this.formatCommand.bind(this, message, prefix, true)).join('\n'))
        .setThumbnail("https://images-ext-1.discordapp.net/external/o03EtAvKWPy_yjaQx-iLF3900MX79QsQ5SiXfU3-UK0/https/discordbots.app/logo.png?width=613&height=613")
        .setImage("https://images-ext-2.discordapp.net/external/GVMApGIbCorhH-v6d25uRvIFcUBVR4QyAg4KRvbslY0/https/images-ext-1.discordapp.net/external/x-h19WtJgfxI-ptRV1xSzZ4xUokie1jCnXmzAN-UYyo/https/share.creavite.co/yqB46JCBxA0Wa5lF.gif")
			);
		}
