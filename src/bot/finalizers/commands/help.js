	...
	async buildDisplay(message) {
		...
		for (const [category, list] of commands) {
			display.addPage(new MessageEmbed()
				.setAuthor(`${category} Commands`, "https://discordbots.app/logo.png")
				.setColor(color)
				.setDescription(list.map(this.formatCommand.bind(this, message, prefix, true)).join('\n'))
        .setThumbnail("https://discordbots.app/logo.png")
        .setImage("https://images-ext-1.discordapp.net/external/x-h19WtJgfxI-ptRV1xSzZ4xUokie1jCnXmzAN-UYyo/https/share.creavite.co/yqB46JCBxA0Wa5lF.gif")
			);
		}
